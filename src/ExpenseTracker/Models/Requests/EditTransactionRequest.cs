...
/// <summary>
/// Represents the data required to edit a transaction.
/// </summary>
public class EditTransactionRequest
{
    /// <summary>
    /// Initializes a new instance of the <see cref="EditTransactionRequest"/> class.
    /// </summary>
    ...
    public EditTransactionRequest(string description, DateTime date, string category, decimal amount)
    {
