...
public class ConsoleView
{
    ...
    public string GetDescription(bool isEditMode = false)
    {
        string input = this.GetValidatedInput(
            ...
            isEditMode,
            ViewValidator.IsValidDescription,
    ...
    public string GetCategory(bool isEditMode = false)
    {
        string input = this.GetValidatedInput(
            $"Enter the category of the transaction: ",
            isEditMode,
            ViewValidator.IsValidCategory,
            $"Category can't be empty and should only contain alphabets.");
    ...
    public string GetId()
    {
        return this.GetValidatedInput("Select the transaction by id: ", false, ViewValidator.IsValidId, "Enter the ID in the format (I001)");
    }
