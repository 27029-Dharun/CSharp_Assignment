namespace Assignment2.Models.BankingSystem
{
    ...
    internal class SavingsAccount : BankAccount
    {
        ...
        internal SavingsAccount(string name, string accountNumber, decimal initialAmount)
        ...
        internal override string PrintDetails() => $"Your Savings Account with Account Number: {this.AccountNumber} has Balance {this.Balance}";
    }
}
