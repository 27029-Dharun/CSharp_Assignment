...
The application automatically calculates the manager bonus according to the implemented business rule.
...
The application calculates the developer bonus and displays:
...
The Savings Account maintains a minimum balance.
